/*****************************************************************************
 *
 * stdc.c: Things missing or incorrect from ANSI library for given platform.
 *
...
_void *
memmove(_void *targ, _const _void *src, size_t n)
{
	char	    *ct = (char *)        targ;
	_const char *cs = (_const char *) src;
...
int
sprintf(char *s, _const char *format, ...)
{
	va_list argp;
...
int
_cc_printf(_const char *format, ...)
{
	int	cc;
	va_list argp;

	va_start(argp, format);
	cc = _cc_vfprintf(stdout, format, argp);
	va_end(argp);
...
int
_cc_vprintf(_const char *format, va_list argp)
{
	return _cc_vfprintf(stdout, format, argp);
}

int
_cc_fprintf(FILE *f, _const char *format, ...)
{
	int	cc;
	va_list argp;

	va_start(argp, format);
	cc = _cc_vfprintf(f, format, argp);
	va_end(argp);
...
int
_cc_vfprintf(FILE *f, _const char *format, va_list argp)
{
	unsigned long fp = ftell(f);
