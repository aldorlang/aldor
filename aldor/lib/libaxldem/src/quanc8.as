...
+++  in ``Computer Methods for Mathematical Computations'' by Forsythe, Malcolm
+++  and Moler, Prentice-Hall 1977.)
+++
...
== {
	...
	local w0, w1, w2, w3, w4, area, x0, f0, stone, step, cor11, temp: R;
	local qprev, qnow, qdiff, qleft, esterr, tolerr: R;
	default i, j : I;
