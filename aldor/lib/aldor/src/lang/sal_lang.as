...
+++ ForeignLanguage improve the Foreign() constructor typechecking in user
+++ code. The compiler itself doesn't care about the signatures.
ForeignLanguage:Category == with;
...
+++
+++ Overview: Undocumented
C: ForeignLanguage == add;
C(headers:Literal):ForeignLanguage == add;
...
+++
+++ Overview: Undocumented
Foreign(Lang: ForeignLanguage): ForeignLanguage == add;
