...
import from R, I, TextWriter, Character, String;
...
if zero? flag then {
  stdout << "result = " << result << newline;
  stdout << "error = " << errest << newline;
  stdout << "(after " << nofun << " function evaluations)" << newline;
}
else
  stdout << "error flag is " << flag << newline;
