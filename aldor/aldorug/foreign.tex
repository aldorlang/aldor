% *********************************************************************
\head{chapter}{Interfaces to other programming languages}{asugForeign}
% *********************************************************************

% *********************************************************************
\head{section}{Foreign function interface}{asugForeignSyntax}
% *********************************************************************

Functions or data structures may be imported from foreign environments
\index{import!of foreign objects}
into \asharp{} programs.
The following example shows how to call a C function:
\index{import!of C objects}
\index{C functions!calling}

{\small
\verbatiminput{forn1.as}
}

Here is the output from compiling and running the above program
via {\tt \asharpcmd{} -r forn1.as:}
\index{compiler options!r@\protect{\tt -r} (run program)}
\index{running a program}

{\small
\verbatiminput{forn1.out}
}
